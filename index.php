            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <span class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-purple-500">
                            FitFlow
                        </span>
                    </div>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="#" class="nav-item text-gray-700 hover:text-indigo-600 transition-colors duration-300">Home</a>
                    <a href="#" class="nav-item text-gray-700 hover:text-indigo-600 transition-colors duration-300">About</a>
                    <a href="#" class="nav-item text-gray-700 hover:text-indigo-600 transition-colors duration-300">Features</a>
        ...
        <div class="max-w-7xl mx-auto">
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative animate-float">
                    ...
                    <img src="/api/placeholder/600/400" alt="Fitness Dashboard" class="relative rounded-3xl shadow-2xl">
                </div>
            </div>
        </div>
    </section>
