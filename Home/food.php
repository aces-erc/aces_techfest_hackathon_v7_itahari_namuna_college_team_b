...
<?php include 'navbar.php'; ?>
    ...
    <div class="search-container fixed w-[50%] overflow-hidden mt-50 z-50 flex items-center p-4">
   
    <input
        type="text"
        id="search"
        placeholder="Search for food..."
        class="search-input w-full sm:w-3/4 md:w-2/3 lg:w-1/2 p-4 rounded-l-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-500 text-gray-800 text-lg overflow-hidden">
    <button
        id="searchButton"
        class="bg-blue-500 text-white px-6 py-4 rounded-r-full text-lg font-medium shadow-md hover:bg-blue-600 transition-colors">
        Search
    </button>
</div>

<div class="overflow-auto h-screen pt-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
